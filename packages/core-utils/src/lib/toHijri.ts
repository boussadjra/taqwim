...
export function toHijri(date: DateObject | Date): { hy: number; hm: number; hd: number } | null
export function toHijri(year: number, month: number, day: number): { hy: number; hm: number; hd: number } | null
export function toHijri(date: string): { hy: number; hm: number; hd: number } | null
