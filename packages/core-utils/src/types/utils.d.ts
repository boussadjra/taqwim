/*
Credit to date-io for the original typescript definitions
...
export interface IUtils<TDate, TLocale> {
  ...
  date<
    ...
    TResultingDate extends unknown = TArg extends null ? null : TArg extends undefined ? TDate : TDate | null,
  >(
    value?: TArg,
  ): TResultingDate
